...
|---|---|---|
| [`src/`](./src) | `@trustknots/server-aws` | Lambda handlers, vcknots context, and utilities |
...
Infrastructure is defined in `resources/` using AWS CDK. Handler source code lives in `src/`.
