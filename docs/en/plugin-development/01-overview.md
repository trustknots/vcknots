...
In other words, `providers` allow you to replace peripheral implementations or extend supported functionality without modifying the core logic of VC Knots.
